...
SCENES = [
    ...
    Scene(RGB(255,230,230), RGB(199,84,193),RGB(237,28,36), RGB(255,230,230), ["./bmps/pinkcake_1.bmp", "./bmps/pinkcake_2.bmp", "./bmps/pinkcake_3.bmp", "./bmps/pinkcake_4.bmp"], 1, BirthdayAction),          # -2-  Birthday
