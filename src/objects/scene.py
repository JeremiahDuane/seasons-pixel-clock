...
SCENES = [
    ...
    Scene(RGB(200,190,0), RGB(255,190,0), "./bmps/scarecrow_1.bmp", "./bmps/scarecrow_2.bmp"),                  # -8-  Scarecrow
    Scene(RGB(200,190,0), RGB(255,190,0), "./bmps/pumpkin_1.bmp", "./bmps/pumpkin_2.bmp"),                      # -8-  Pumpkin
