...
def BirthdayAction(graphics, canvas, font, clrPrimary, clrSecondary, year):
    color = graphics.Color(200,150,255)
...
SCENES = [
    ...
    Scene(RGB(255,255,255), RGB(255,150,255), "./bmps/pumpkin_1.bmp", "./bmps/pumpkin_2.bmp"),     # -8-  August Sunflowers
    Scene(RGB(255,255,255), RGB(255,150,255), "./bmps/scarecrow_1.bmp", "./bmps/scarecrow_2.bmp"),     # -8-  August Sunflowers
