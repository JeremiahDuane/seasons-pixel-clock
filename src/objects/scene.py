...
SCENES = [
    ...
    Scene(RGB(0,180,0), RGB(255,0,0),RGB(255, 0, 0), RGB(255,200,0), ["./bmps/wreath_1.bmp", "./bmps/wreath_2.bmp"], 4),                                                                                            # -6-  Wreath
    Scene(RGB(255,255,255), RGB(0,255,255), RGB(255,255,255), RGB(94,40,0), ["./bmps/snowman_1.bmp", "./bmps/snowman_2.bmp"], 4),                                                                                # -7-  Snowman
