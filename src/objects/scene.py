...
class Scene:    
    def __init__(self, primaryColor, secondaryColor, tertiaryColor, quaternaryColor, bmps, tempo, isNow, action=None):      
...
SCENES = [
    ...
    Scene(
        ...
        1, 
        lambda y, m, d: m == 10 and d == 3,
        BirthdayAction
    ),                                                                                                            # -2-  Birthday
    Scene(
        RGB(255,255,255), RGB(255,180,255), RGB(255,255,255), RGB(255,218,15),
