...
SCENES = [
    ...
    Scene(RGB(255,240,240), RGB(255,255,255), ["./bmps/daffodil_1.bmp", "./bmps/daffodil_2.bmp"], 4),                                                                      # -3-  Daffodil
    ...
    Scene(RGB(255,240,240), RGB(255,255,0), 
    ...
    Scene(RGB(255,150,0), RGB(255,50,80), ["./bmps/turkey_1.bmp", "./bmps/turkey_2.bmp", "./bmps/turkey_3.bmp"], 2),                                                     # -9-  Turkey7
]